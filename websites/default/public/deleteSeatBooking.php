...
$title = 'Fotheby\'s - Delete Seat Booking Request';
require '../head.php';
require '../nav.php';
...
if(isset($_SESSION['adminloggedin'])) {
    ...
    if(isset($_GET['bookingID'])) {
        $removeCategory = $pdo->prepare('DELETE FROM seatBookingRequests WHERE bookingID = :bookingID');
        $removeCategory ->execute($_GET);

    echo '<p>Seat Booking Request Deleted</p>';
    }
}
