<?php
    ...
    if (isset($_GET['collectionId'])) {
        ...
        echo '<h3>' . $_GET['collectionId'] . ' Collection </h3>';
        ...
        $selectCol = $pdo->prepare('SELECT * FROM article WHERE collectionTitle= :collectionId');
        $value = [
